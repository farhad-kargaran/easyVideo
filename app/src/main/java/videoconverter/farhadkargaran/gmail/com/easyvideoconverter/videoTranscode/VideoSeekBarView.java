...
public class VideoSeekBarView extends View {
    ...
    private void init(Context context) {
        if (thumbDrawable1 == null) {
            thumbDrawable1 = Helper.getDrawable(R.drawable.videolapse);
            innerPaint1.setColor(0x99999999);
            //innerPaint1.setColor( Helper.getThemePrimaryColors(TranscodeAvtivity.)[0]);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(thumbWidth / 2, getMeasuredHeight() / 2 - Helper.dp(1), getMeasuredWidth() - thumbWidth / 2, getMeasuredHeight() / 2 + Helper.dp(1), innerPaint1);
